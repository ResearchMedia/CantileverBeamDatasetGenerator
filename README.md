...
├── COMSOL
│   ├── FrequencyAnalysis_wMPF_cross_platform.mph
│   ├── README.txt
│   └── StaticAnalysis_cross_platform.mph
├── DatasetAugmentation
│   ├── csv2numpy.py
│   ├── eigencsv2numpy.py
...
```
5) Use [FrequencyAnalysis_wMPF_cross_platform.mph](COMSOL/FrequencyAnalysis_wMPF_cross_platform.mph) and [FEAStaticAnalysis_cross_platform.mph](COMSOL/StaticAnalysis_cross_platform.mph) to analyze the beams. Please note that an installation of COMSOL Multiphysics 5.4 including the CAD Import Module is required to run these analyses.
...
3) Use FrequencyAnalysis_wMPF_cross_platform.mph and FEAStaticAnalysis_cross_platform.mph to analyze the beams. Please note that an installation of COMSOL Multiphysics 5.4 including the CAD Import Module is required to run these analyses.
